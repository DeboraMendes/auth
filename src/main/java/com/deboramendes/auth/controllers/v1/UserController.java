...
public interface UserController {
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400.1.1.001", description = "Invalid data", content = {@Content(schema = @Schema(implementation = AppExceptionResponseDTO.class))}),
            @ApiResponse(responseCode = "406.1.2.001", description = "User already exists", content = {@Content(schema = @Schema(implementation = AppExceptionResponseDTO.class))}),
    })
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400.1.1.001", description = "Invalid data", content = {@Content(schema = @Schema(implementation = AppExceptionResponseDTO.class))}),
            @ApiResponse(responseCode = "401.3.2.002", description = "User not found", content = {@Content(schema = @Schema(implementation = AppExceptionResponseDTO.class))}),
            @ApiResponse(responseCode = "401.3.2.003", description = "Invalid user password", content = {@Content(schema = @Schema(implementation = AppExceptionResponseDTO.class))}),
    })
